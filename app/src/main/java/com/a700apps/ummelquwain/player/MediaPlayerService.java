...
/**
 * Created by mohamed.arafa on 9/28/2017.
 */
...
//    private MediaStore.Audio activeAudio; //an object on the currently playing audio
    ...
    private String StreamLink = "http://20073.live.streamtheworld.com/DANCE_FM_SC";
...
//        new StorageUtil(getApplicationContext()).storeAudioIndex(audioIndex);
    ...
    private void updateMetaData() {
        ...
        mediaSession.setMetadata(new MediaMetadataCompat.Builder()
                ...
                .putString(MediaMetadataCompat.METADATA_KEY_ARTIST, "Current Program")
                .putString(MediaMetadataCompat.METADATA_KEY_ALBUM, "Category")
    ...
    private void buildNotification(PlaybackStatus playbackStatus) {
        ...
        NotificationCompat.Builder notificationBuilder = (NotificationCompat.Builder) new NotificationCompat.Builder(this)
                ...
                .setContentText("Current Program")
                .setContentTitle("Category")
                .setContentInfo("Station Name")
