...
import com.a700apps.ummelquwain.ui.screens.landing.media.albums.media.videos.details.VideoDetailsFragment;
...
public class VideosPresenter implements MediaContract.UserAction, LifecycleObserver {
    ...
    public VideosPresenter(Context mContext, MediaContract.View mView, FragmentManager mFragmentManager, Lifecycle lifecycle, int albumID, int mediaType) {
    ...
    public void openDetails(int mediaID, int mediaType) {
        mFragmentManager.beginTransaction().addToBackStack(null)
                .add(R.id.fragment_container, VideoDetailsFragment.newInstance(mediaID)).commit();
    }
}
