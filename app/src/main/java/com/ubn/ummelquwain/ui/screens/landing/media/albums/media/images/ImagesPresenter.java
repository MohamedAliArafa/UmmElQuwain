...
import com.ubn.ummelquwain.ui.screens.landing.media.albums.media.images.details.ImageDetailsFragment;
...
public class ImagesPresenter implements MediaContract.UserAction, LifecycleObserver {
    ...
    public void openDetails(List<MediaResultModel> media, int position) {
        mFragmentManager.beginTransaction().addToBackStack(null)
                .replace(R.id.fragment_container, ImageDetailsFragment.newInstance(media, position)).commit();
    }
}
